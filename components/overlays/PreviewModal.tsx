...
export const PreviewModal: React.FC<PreviewModalProps> = ({ item, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[130] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm" onClick={onClose}>
      <div className="bg-white border-4 border-black w-full max-w-5xl h-[90vh] flex flex-col shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] animate-in fade-in zoom-in-95 duration-200" onClick={e => e.stopPropagation()}>
