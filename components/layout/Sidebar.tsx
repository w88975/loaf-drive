...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const SidebarItem: React.FC<{
    ...
    <NavLink
      ...
      className={({ isActive }) =>
        `w-full flex items-center space-x-3 px-4 py-3 rounded-none transition-all duration-200 border-l-4 ${
          isActive
            ? "bg-yellow-400 border-black text-black font-bold"
  ...
  return (
    <>
       ...
       */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-64 bg-white border-r-2 border-black transform transition-transform duration-300 md:relative md:translate-x-0 ${
